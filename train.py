...
def create_arguments():
    ...
    parser.add_argument('--arch', dest='arch', default='densenet201', choices=archs, help='choose the desired model architecture')
    parser.add_argument('--hidden_units', dest='hidden_units', default=[1024,512], nargs='+', help='choose the desired hidden layer architecture')
    parser.add_argument('--learning_rate', dest='learning_rate', default='0.01', help='choose the desired learning rate')
